...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    ...
    avatarUrl: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCommentComment extends Schema.CollectionType {
  ...
  attributes: {
    ...
    avatarUrl: Attribute.String &
      Attribute.DefaultTo<'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8YXZhdGFyfGVufDB8fDB8fHww'>;
    website: Attribute.String & Attribute.Required;
    postId: Attribute.String & Attribute.Required;
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    publicationDate: Attribute.Date &
      Attribute.Required &
      Attribute.DefaultTo<'2024-06-15'>;
    imageUrl: Attribute.String & Attribute.Required;
    authorId: Attribute.Integer & Attribute.Required;
    views: Attribute.Integer & Attribute.Required;
    likes: Attribute.Integer & Attribute.Required;
    shared: Attribute.Integer & Attribute.Required;
...
export interface ApiPostTagPostTag extends Schema.CollectionType {
  ...
  attributes: {
    postId: Attribute.String & Attribute.Required;
    tagId: Attribute.String & Attribute.Required;
    post: Attribute.Relation<
      'api::post-tag.post-tag',
      'manyToOne',
      'api::post.post'
